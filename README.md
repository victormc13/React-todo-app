...
<!-- - [React-todo-app](https://victormc13.github.io/React-todo-app/) -->
...
```sh
  cd my-folder
  git clone https://github.com/victormc13/React-todo-app.git
```
...
Feel free to check the [issues page](https://github.com/victormc13/React-todo-app/issues).
